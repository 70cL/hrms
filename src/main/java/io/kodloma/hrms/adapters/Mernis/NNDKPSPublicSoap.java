...
public class NNDKPSPublicSoap
{
    ...
    public NNDKPSPublicSoap(){}

    public NNDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NNDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NNDExtendedSoapSerializationEnvelope envelope= new NNDExtendedSoapSerializationEnvelope(NNDExtendedSoapSerializationEnvelope.VER11);
