...
public class NNDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NNDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NNDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NNDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NNDDateTimeConverter dateTimeConverter = new NNDStandardDateTimeConverter();

    public NNDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NNDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NNDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NNDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NNDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NNDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
